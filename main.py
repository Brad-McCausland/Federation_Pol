...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        popModel.setValueForClusters(20, POP_METRIC_SPECIES.HUMAN, POP_METRIC_NATIONALITY.HUMAN, POP_METRIC_EMPLOYMENT.ACADEMIC, POP_METRIC_SOCIOECO.LOWER, POP_METRIC_AGE.POP_20_UNDER, POP_METRIC_BELIEFS.CENTER_LEFT, POP_METRIC_APPROVAL.APPROVES)
        popModel.setValueForClusters(50, POP_METRIC_SPECIES.LUVERAN, POP_METRIC_NATIONALITY.HUMAN, POP_METRIC_EMPLOYMENT.ACADEMIC, POP_METRIC_SOCIOECO.LOWER, POP_METRIC_AGE.POP_20_UNDER, POP_METRIC_BELIEFS.CENTER_LEFT, POP_METRIC_APPROVAL.APPROVES)
