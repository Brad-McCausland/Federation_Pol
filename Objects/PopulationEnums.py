...
#Abstract class which holds static properties which relate to pop enums
class PopulationEnums():
    TOTAL_TAG_COUNT = 7

    # TODO: Possible to derive? Hard coding bad.
    MEMBER_ENUM_COUNTS = [6, 6, 9, 6, 7, 9, 2]
